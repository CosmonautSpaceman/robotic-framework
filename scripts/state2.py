...
######################################################################################
    ...
    X1, Xd1, Xdd1, Q1, Qd1, Qdd1, J1, Jd1, Jdd1 = trj.from_jointspace()
...
######################################################################################
    ...
    while not rospy.is_shutdown():
        for i in range(sampcol):
            ...
            # Error signal
            sim.feedbackError3('quaternion')

            # Inverse Dynamics
            joint()
            sim.jointState.q = q
            sim.jointState.qd = qd
            sim.jointState.qnull = np.array([0.0, 0.0, 0.0, -1.5707, 0.0, 1.5707, 1.5707])
